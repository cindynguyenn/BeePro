...
def record_audio(event, duration, start_time, end_time):
    global recording
    fs = 4000
    file_number = 1
...
# RUN LOCALLY OR GOOGLE UPLOAD ----------------------------------------------------------------------------------------
        ...
        if not values ['newTime'] or not values ['startTime'] or not values ['endTime']:
            print("Please set a duration, start time, and end time before starting recording.")
            continue
        recording = True  # Start recording
        duration = int(values['newTime'])
        start_time = datetime.strptime(values['startTime'], '%HH:%MM'.time())
        end_time = datetime.strptime(values['endTime'], '%HH:%MM'.time())
...
# SET TIME BUTTON -----------------------------------------------------------------------------------------------------
        ...
        start_time = int(values['startTime'])
        end_time = int(values['endTime'])
